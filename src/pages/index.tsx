  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless dining with Restaurant Booking Engine - Your ultimate solution for table reservations and menu management, powered by MongoDB."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless dining with Restaurant Booking Engine - Your ultimate solution for table reservations and menu management, powered by MongoDB.`}
            </Text>
            <Box
